...
void T::setParametersShape(int pos_x, int pos_y, QSize size_rect){
    ...
    if(checkArgumentsShape(pos_x,pos_y,size_rect)){
     ...
     figure.push_back(QRect(QPoint(x + 20, y),size_rect));   //1
     figure.push_back(QRect(QPoint(x, y + 20),size_rect));   //2
     figure.push_back(QRect(QPoint(x - 20, y),size_rect));   //3
...
void T::rotateShape(){
    ...
    case 0: {
        int x = figure.value(0).x();      //4
        int y = figure.value(0).y();      //4
   ...
   case 1: {
        int x = figure.value(0).x();      //0
        int y = figure.value(0).y();      //0
    ...
    case 2: {
        int x = figure.value(0).x(); //1
        int y = figure.value(0).y();      //1
 ...
 //    }
    ...
    case 3: {
        int x = figure.value(0).x(); //2
        int y = figure.value(0).y(); //2
        if(!figure.isEmpty()) {
            destroyShape();
        }
        figure.push_front(QRect(QPoint(x , y), shape_configuration.size));
